                ...
                <Link to="/home-2" className="navbar-brand logo">
                  {pathnames.includes("/index-5") ? (
                    <img src={logo_white} className="img-fluid" alt="Logo" />
                      ...
                      "/react/template-rtl/Pharmacy/Pharmacy-index"
                    ) ? (
                    ...
                    <img
                      src={
                        pathnames === "/react/template-rtl/index-6" ||
                        pathnames === "/react/template-rtl/index-4"
                          ? logosvg
                          : pathnames === "/react/template-rtl/index-11"
                          ? logo_15
                          : pathnames === "/react/template-rtl/index-10"
                          ? logo_15
                          : pathnames === "/react/template-rtl/index-9"
                          ? logo_03
                          : pathnames === "/react/template-rtl/index-7"
                          ? logo_svg
                          : pathnames == "/react/template-rtl/index-13"
                          ? logo_white
                          : logosvg
                      }
                      className="img-fluid"
