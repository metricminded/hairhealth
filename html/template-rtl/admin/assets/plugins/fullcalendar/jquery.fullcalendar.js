    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            form.find(".event-inputs")
                .append("<div class='forms-block'><label class='control-label'>Event Name</label><input class='form-control' placeholder='Insert Event Name' type='text' name='title'/></div>")
                .append("<div class='forms-block'><label class='control-label'>Category</label><select class='form-control' name='category'></select></div>")
